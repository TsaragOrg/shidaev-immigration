...
|---|---|---|
| Calendly | Запись на консультацию | Popup-режим из Hero главной и с `/contact`; остальные CTA ведут на `/contact`. URL задаётся через `NEXT_PUBLIC_CALENDLY_URL`. Детали — `docs/04-функции/запись-на-консультацию.md`. |
